...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 16, 2025 at 01:18 PM
...
-- (30, 18, 34, 0, 0, 0, 0, 0, 0),
-- (31, 18, 35, 0, 0, 0, 0, 0, 0);
...
-- (29, 1, 'challenge', 'java', NULL, NULL, 'easy', 2, 20, 'public class MyClass {\n    public static void main(String[] args) {\n        System.out.println(\"Hello Java!\");\n    }\n}'),
-- (34, 18, 'story', 'java', 0, 0, NULL, NULL, 0, ''),
-- (35, 18, 'challenge', 'java', NULL, NULL, '', 0, 0, '');
...
-- (16, 'Hans-Axle', '$2y$10$CxbXWgEcAjlCJNYrAVa/K.HyvNF9ExzplVrgYwcyYo0r.dqGWqBGq', 'java', '2025-10-13 06:46:42'),
-- (18, 'qwe', '$2y$10$4M67syNPoK1aSYlfYEpe6OfGR8QUgwCD7wWwRM510o4WipEvNLwDi', 'java', '2025-10-16 09:31:54');
