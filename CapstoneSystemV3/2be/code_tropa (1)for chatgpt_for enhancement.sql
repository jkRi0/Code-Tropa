...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2025 at 11:16 AM
...
CREATE TABLE `performance` (
  ...
  `accuracy` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '0' CHECK (json_valid(`accuracy`)),
  `efficiency` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '0' CHECK (json_valid(`efficiency`)),
  `readability` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '0' CHECK (json_valid(`readability`)),
  `time` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '0' CHECK (json_valid(`time`)),
  `success` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '0' CHECK (json_valid(`success`)),
  `failed` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '0' CHECK (json_valid(`failed`))
...
(3, 4, 2, '0', '0', '0', '0', '0', '0'),
(22, 26, 35, '10', '0', '0', '0', '0', '0'),
(23, 26, 36, '0', '10', '0', '0', '0', '0'),
(24, 26, 37, '0', '0', '10', '0', '0', '0');
...
(26, 'qweqwe', '$2y$10$3d6PxXIU.mlzxvWS0dY42OZ2zLUWF8s0LIT5n4wgLrV6FtsJCLrS6', 'java', '2025-10-03 03:17:23');
