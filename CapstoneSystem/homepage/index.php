                        ...
                        <div class="forScroll">
                            <div class="epi-selection chap1">
                                <div class="epi-option">
                                    ...
                                    <button onclick="location.href='sm/ep1'">Play</button>
                                </div>
                        ...
                        <div class="epi-selection lev1">
                            <div class="epi-option">
                                <picture>
                                    ...
                                    <img src="../assets/samplebg.jpg" alt="Episode Background" class="responsive-episode-image">
                                </picture>
                                <div class="epi-title">
                                    <h2>Taho Time!</h2>
                                </div>
            ...
            <div class="dif-selection-back1">
                <div class="pl-selection">
                    ...
                    <div class="outer-button">
                        ...
                        <div class="act-button" onclick="difActions('back')">Ok</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="leaderboard-section">
                        ...
                        <div class="leaderboard-content">
                            ...
                            <div class="leaderboard-entry">
                                <div class="entry-item">1</div>
                                <div class="entry-item">Player 1</div>
                                <div class="entry-item">Gold</div>
                                <div class="entry-item">1500</div>
                            </div>
                            <div class="leaderboard-entry">
                                <div class="entry-item">2</div>
                                <div class="entry-item">Player 2</div>
                                <div class="entry-item">Silver</div>
                                <div class="entry-item">1200</div>
                            </div>
                            <div class="leaderboard-entry current-player">
                                <div class="entry-item">3</div>
                                <div class="entry-item">Player 3</div>
                                <div class="entry-item">Bronze</div>
                                <div class="entry-item">900</div>
                            </div>
                            <div class="leaderboard-entry">
                                <div class="entry-item">4</div>
                                <div class="entry-item">Player 4</div>
                                <div class="entry-item">Gold</div>
                                <div class="entry-item">1600</div>
                            </div>
                            <div class="leaderboard-entry">
                                <div class="entry-item">5</div>
                                <div class="entry-item">Player 5</div>
                                <div class="entry-item">Silver</div>
                                <div class="entry-item">1100</div>
                            </div>
                            <div class="leaderboard-entry">
                                <div class="entry-item">6</div>
                                <div class="entry-item">Player 6</div>
                                <div class="entry-item">Bronze</div>
                                <div class="entry-item">800</div>
                            </div>
                            <div class="leaderboard-entry">
                                <div class="entry-item">7</div>
                                <div class="entry-item">Player 7</div>
                                <div class="entry-item">Gold</div>
                                <div class="entry-item">1700</div>
                            </div>
                            <div class="leaderboard-entry">
                                <div class="entry-item">8</div>
                                <div class="entry-item">Player 8</div>
                                <div class="entry-item">Silver</div>
                                <div class="entry-item">1300</div>
                            </div>
                            <div class="leaderboard-entry">
                                <div class="entry-item">9</div>
                                <div class="entry-item">Player 9</div>
                                <div class="entry-item">Bronze</div>
                                <div class="entry-item">1000</div>
                            </div>
                            <div class="leaderboard-entry">
                                <div class="entry-item">10</div>
                                <div class="entry-item">Player 10</div>
                                <div class="entry-item">Gold</div>
                                <div class="entry-item">1800</div>
                            </div>
                            <div class="leaderboard-entry">
                                <div class="entry-item">11</div>
                                <div class="entry-item">Player 11</div>
                                <div class="entry-item">Platinum</div>
                                <div class="entry-item">2000</div>
                            </div>
                            <div class="leaderboard-entry">
                                <div class="entry-item">12</div>
                                <div class="entry-item">Player 12</div>
                                <div class="entry-item">Diamond</div>
                                <div class="entry-item">2500</div>
                            </div>
                            <div class="leaderboard-entry">
                                <div class="entry-item">13</div>
                                <div class="entry-item">Player 13</div>
                                <div class="entry-item">Silver</div>
                                <div class="entry-item">1250</div>
                            </div>
                            <div class="leaderboard-entry">
                                <div class="entry-item">14</div>
                                <div class="entry-item">Player 14</div>
                                <div class="entry-item">Gold</div>
                                <div class="entry-item">1550</div>
                            </div>
                            <div class="leaderboard-entry">
                                <div class="entry-item">15</div>
                                <div class="entry-item">Player 15</div>
                                <div class="entry-item">Bronze</div>
                                <div class="entry-item">950</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="chap-selection-outer">
                        ...
                        <div class="epi-selection profile">
                            <div class="profile-info">
                                ...
                                <p><strong>Current Points:</strong> 1500</p>
                                <p><strong>Current Tier Level:</strong> Gold</p>
                            </div>
                            ...
                            <div class="profile-performance">
                                ...
                                <div class="bar-graph-container">
                                    <div class="bar-wrapper">
                                        <div class="bar bar-accuracy" style="height: 85%;"><span class="bar-percentage-label">85%</span></div>
                                    </div>
                                    <div class="bar-wrapper">
                                        <div class="bar bar-efficiency" style="height: 70%;"><span class="bar-percentage-label">70%</span></div>
                                    </div>
                                    <div class="bar-wrapper">
                                        <div class="bar bar-readability" style="height: 60%;"><span class="bar-percentage-label">60%</span></div>
                                    </div>
                                    <div class="bar-wrapper">
                                        <div class="bar bar-time" style="height: 90%;"><span class="bar-percentage-label">90%</span></div>
                                    </div>
                                    <div class="bar-wrapper">
                                        <div class="bar bar-success" style="height: 95%;"><span class="bar-percentage-label">95%</span></div>
                                    </div>
                                    <div class="bar-wrapper">
                                        <div class="bar bar-failed" style="height: 20%;"><span class="bar-percentage-label">20%</span></div>
                                    </div>
                                </div>
                                <div class="chart-legends">
                                    ...
                                    <p><span class="legend-color legend-color-success"></span> Success</p>
                                    <p><span class="legend-color legend-color-failed"></span> Failed</p>
                                </div>
                            </div>
